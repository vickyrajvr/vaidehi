                        ...
                        <View style={{ flexDirection: 'column', width: width - 20 }}>
                            <View style={{ flexDirection: isRTL ? 'row-reverse' : 'row' }}>
                                <View style={{ width: 30, alignItems: 'center' }}>
                                    <Ionicons name="md-location-sharp" size={24} color={colors.GREEN} />
                            ...
                            <View style={{ flexDirection: isRTL ? 'row-reverse' : 'row' }}>
                                <View style={{ width: 30, alignItems: 'center' }}>
                                    <Ionicons name="md-location-sharp" size={24} color={colors.RED} />
                                </View>
                    ...
                    <View style={{ flexDirection: 'column', flex: 1, minHeight: 60 }}>
                        <View style={{ flexDirection: isRTL ? 'row-reverse' : 'row', flex: 1, minHeight: 60 }}>
                            <View style={[styles.details, { flexDirection: isRTL ? 'row-reverse' : 'row'}]}>
                                <Text style={{ fontWeight: 'bold', fontSize: 24, color: MAIN_COLOR, opacity: 0.7 }}>{settings.symbol}</Text>
                                ...
                                {paramData && paramData.trip_start_time && paramData.trip_end_time ?
                                    <View style={{ flexDirection: isRTL ? 'row-reverse' : 'row' }}>
                                        <View style={[styles.section,{flexDirection: isRTL ? 'row-reverse' : 'row'}]}>
                                            <Ionicons name="md-location-sharp" size={28} color={colors.GREEN} />
                                            <View>
                                        ...
                                        <View style={[styles.section,{flexDirection: isRTL ? 'row-reverse' : 'row'}]}>
                                            <Ionicons name="md-location-sharp" size={28} color={colors.RED} />
                                            <View>
                                                <View style={{ flexDirection: 'row' }}>
                                                ...
                                                <Text style={{ textAlign: isRTL ? "right" : "left", fontSize: 8 }}>{paramData.endTime ? moment(paramData.endTime).format('ll') : ''}</Text>
                                            </View>
                                        </View>
                                    </View>
                                    : paramData && paramData.trip_start_time ?
                            ...
                            {paramData && ((paramData.driver_contact || paramData.customer_contact)) ?
                                <View style={{ flexDirection: isRTL ? 'row-reverse' : 'row', alignItems: 'center' }}>
                                   <TouchableOpacity onPress={() => (['ACCEPTED', 'ARRIVED', 'STARTED', 'REACHED', 'PENDING'].indexOf(paramData.status) != -1) ? role == 'customer' ? 
                                            onPressCall(paramData.driver_contact) : (appConsts.canCall ? onPressCall(paramData.customer_contact) : setUserInfoModalStatus(true)) : onAlert(paramData)} 
                                    ...
                                    <TouchableOpacity onPress={() => (['ACCEPTED', 'ARRIVED', 'STARTED', 'REACHED', 'PENDING'].indexOf(paramData.status) != -1) ? onChatAction(paramData, paramData.id) : onAlert(paramData)} style={{ backgroundColor: MAIN_COLOR, height: 40, width: 40, borderRadius: 20, justifyContent: 'center', alignItems: 'center', margin: 3 }}>
