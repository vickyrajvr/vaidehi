            ...
            <View style={styles.vew}>
                ...
                <KeyboardAvoidingView style={styles.form} behavior={Platform.OS == "ios" ? "padding" : (__DEV__ ? null : "padding")} keyboardVerticalOffset={Platform.OS === 'ios' ? 150 : 0}>
                    <ScrollView showsVerticalScrollIndicator={false} >
                        ...
                        <Text style={{ textAlign: 'center', fontWeight: 'bold', fontSize: 25, marginTop: 18 }}>{t('how_your_trip')}</Text>
                        <Text style={{ textAlign: 'center', marginTop: 10 }}>{t('your_feedback_test')}</Text>
                        <Text style={{ textAlign: 'center', marginTop: 20, fontSize: 20 }}>{t('rate_for')}</Text>
                        <Text style={{ textAlign: 'center', fontSize: 25, fontWeight: 'bold', textTransform: 'capitalize' }}>{booking && booking.driver_name ? booking.driver_name : null}</Text>
                        ...
                        <View style={{ marginHorizontal: 10, }}>
                            ...
                            />
                            <TouchableOpacity onPress={() => skipRating()}><Text style={styles.skip}>{t('skip')}</Text></TouchableOpacity>
                        </View>
                    </ScrollView>
                </KeyboardAvoidingView>
            </View>
